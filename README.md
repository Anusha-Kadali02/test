...
# Person 1: Adapter, Bridge, Builder Patterns {#person-1}
...
# Person 2: Command, Composite, Decorator Patterns {#person-2}

## Your Design Patterns (3):
1. ✅ **Command Pattern** - Booking and car management operations
2. ✅ **Composite Pattern** - Booking packages
3. ✅ **Decorator Pattern** - Booking addons (GPS, Insurance)

## Files to Commit:

### New Files (Untracked):
```
src/main/java/edu/neu/csye7374/command/Command.java
src/main/java/edu/neu/csye7374/command/CommandInvoker.java
src/main/java/edu/neu/csye7374/command/ApproveBookingCommand.java
src/main/java/edu/neu/csye7374/command/CancelBookingCommand.java
src/main/java/edu/neu/csye7374/command/CompleteBookingCommand.java
src/main/java/edu/neu/csye7374/command/AddCarCommand.java
src/main/java/edu/neu/csye7374/command/UpdateCarCommand.java
src/main/java/edu/neu/csye7374/command/DeleteCarCommand.java

src/main/java/edu/neu/csye7374/composite/BookingComponent.java
src/main/java/edu/neu/csye7374/composite/BookingPackage.java
src/main/java/edu/neu/csye7374/composite/CarBookingItem.java
src/main/java/edu/neu/csye7374/composite/AddonItem.java

src/main/java/edu/neu/csye7374/decorator/IBooking.java
src/main/java/edu/neu/csye7374/decorator/BaseBooking.java
src/main/java/edu/neu/csye7374/decorator/BookingDecorator.java
src/main/java/edu/neu/csye7374/decorator/GPSAddOn.java
src/main/java/edu/neu/csye7374/decorator/InsuranceAddOn.java

src/main/java/edu/neu/csye7374/controller/BookingController.java
src/main/java/edu/neu/csye7374/controller/user/UserBookingController.java
src/main/java/edu/neu/csye7374/service/BookingService.java
src/main/java/edu/neu/csye7374/entity/Booking.java
src/main/java/edu/neu/csye7374/repository/BookingRepository.java
src/main/java/edu/neu/csye7374/dto/BookingRequest.java
src/main/java/edu/neu/csye7374/dto/BookingSummaryDTO.java

src/main/java/edu/neu/csye7374/frontend/src/pages/BookingForm.jsx
src/main/java/edu/neu/csye7374/frontend/src/pages/MyBookings.jsx
src/main/java/edu/neu/csye7374/frontend/src/pages/BookingManagementTable.jsx
src/main/java/edu/neu/csye7374/frontend/src/pages/BookingManagementPage.jsx
```

### Modified Files:
```
src/main/java/edu/neu/csye7374/controller/CarController.java
```
...
```bash
# Add your files
git add src/main/java/edu/neu/csye7374/command/
git add src/main/java/edu/neu/csye7374/composite/
git add src/main/java/edu/neu/csye7374/decorator/
git add src/main/java/edu/neu/csye7374/controller/BookingController.java
git add src/main/java/edu/neu/csye7374/controller/user/UserBookingController.java
git add src/main/java/edu/neu/csye7374/service/BookingService.java
git add src/main/java/edu/neu/csye7374/entity/Booking.java
git add src/main/java/edu/neu/csye7374/repository/BookingRepository.java
git add src/main/java/edu/neu/csye7374/dto/BookingRequest.java
git add src/main/java/edu/neu/csye7374/dto/BookingSummaryDTO.java
git add src/main/java/edu/neu/csye7374/controller/CarController.java
git add src/main/java/edu/neu/csye7374/frontend/src/pages/BookingForm.jsx
git add src/main/java/edu/neu/csye7374/frontend/src/pages/MyBookings.jsx
git add src/main/java/edu/neu/csye7374/frontend/src/pages/BookingManagementTable.jsx
git add src/main/java/edu/neu/csye7374/frontend/src/pages/BookingManagementPage.jsx

# Commit
git commit -m "feat: Implement Command, Composite, and Decorator Design Patterns

- Added Command pattern for booking and car management operations
- Implemented Composite pattern for booking packages
- Enhanced Decorator pattern for booking addons (GPS, Insurance)
- Updated BookingService to use decorator for price calculation
- Added booking management UI with edit/cancel functionality
- Added print statements for all pattern activations"
```

## Testing Checklist:
- [ ] Test booking creation with GPS addon (decorator)
- [ ] Test booking creation with Insurance addon (decorator)
- [ ] Test booking creation with both addons (decorator)
- [ ] Test approve booking command
- [ ] Test cancel booking command
- [ ] Test complete booking command
- [ ] Test booking package creation (composite)
- [ ] Test booking package price calculation (composite)
...
# Person 3: Facade, Factory, Flyweight Patterns {#person-3}
...
# Person 4: Observer, Prototype, Singleton Patterns {#person-4}
...
# Person 5: State, Strategy, Template Patterns {#person-5}

## Your Design Patterns (3):
1. ✅ **State Pattern** - Booking lifecycle management
2. ✅ **Strategy Pattern** - Payment, billing, and search strategies
3. ✅ **Template Pattern** - Booking processing workflow

## Files to Commit:

### New Files (Untracked):
```
src/main/java/edu/neu/csye7374/state/BookingState.java
src/main/java/edu/neu/csye7374/state/PendingBookingState.java
src/main/java/edu/neu/csye7374/state/ActiveBookingState.java
src/main/java/edu/neu/csye7374/state/CompletedBookingState.java
src/main/java/edu/neu/csye7374/state/CancelledBookingState.java
src/main/java/edu/neu/csye7374/state/BookingStateFactory.java

src/main/java/edu/neu/csye7374/strategy/payment/PaymentStrategy.java
src/main/java/edu/neu/csye7374/strategy/payment/CardPaymentStrategy.java
src/main/java/edu/neu/csye7374/strategy/payment/UpiPaymentStrategy.java
src/main/java/edu/neu/csye7374/strategy/payment/WalletPaymentStrategy.java
src/main/java/edu/neu/csye7374/strategy/payment/CashPaymentStrategy.java
src/main/java/edu/neu/csye7374/strategy/billing/BillingStrategy.java
src/main/java/edu/neu/csye7374/strategy/billing/HourlyBillingStrategy.java
src/main/java/edu/neu/csye7374/strategy/billing/DailyBillingStrategy.java
src/main/java/edu/neu/csye7374/strategy/billing/WeekendBillingStrategy.java
src/main/java/edu/neu/csye7374/strategy/SearchStrategy.java
src/main/java/edu/neu/csye7374/strategy/ModelSearchStrategy.java
src/main/java/edu/neu/csye7374/strategy/BrandSearchStrategy.java
src/main/java/edu/neu/csye7374/strategy/ClassSearchStrategy.java
src/main/java/edu/neu/csye7374/strategy/FuelSearchStrategy.java
src/main/java/edu/neu/csye7374/strategy/ColorSearchStrategy.java
src/main/java/edu/neu/csye7374/strategy/PriceRangeSearchStrategy.java

src/main/java/edu/neu/csye7374/template/BookingProcessor.java
src/main/java/edu/neu/csye7374/template/StandardBookingProcessor.java
src/main/java/edu/neu/csye7374/template/PremiumBookingProcessor.java

src/main/java/edu/neu/csye7374/controller/AuthController.java
src/main/java/edu/neu/csye7374/service/AuthService.java
src/main/java/edu/neu/csye7374/service/UserService.java
src/main/java/edu/neu/csye7374/controller/UserController.java
src/main/java/edu/neu/csye7374/entity/User.java
src/main/java/edu/neu/csye7374/repository/UserRepository.java
src/main/java/edu/neu/csye7374/dto/LoginRequest.java
src/main/java/edu/neu/csye7374/dto/LoginResponse.java
src/main/java/edu/neu/csye7374/dto/RegisterRequest.java
src/main/java/edu/neu/csye7374/config/JwtAuthenticationFilter.java
src/main/java/edu/neu/csye7374/config/SecurityConfig.java
src/main/java/edu/neu/csye7374/util/JwtUtil.java
```
...
src/main/java/edu/neu/csye7374/controller/AuthController.java
src/main/java/edu/neu/csye7374/service/AuthService.java
src/main/java/edu/neu/csye7374/service/BillingService.java
src/main/java/edu/neu/csye7374/util/JwtUtil.java
src/main/java/edu/neu/csye7374/repository/UserRepository.java
src/main/java/edu/neu/csye7374/frontend/src/components/AppRoutes.jsx
src/main/java/edu/neu/csye7374/frontend/src/components/Layout.jsx
src/main/java/edu/neu/csye7374/frontend/src/context/AuthContext.js
src/main/java/edu/neu/csye7374/frontend/src/pages/Login.jsx
src/main/java/edu/neu/csye7374/frontend/src/pages/Register.jsx
src/main/java/edu/neu/csye7374/frontend/src/pages/Dashboard.jsx
src/main/java/edu/neu/csye7374/frontend/src/services/api.js
src/main/java/edu/neu/csye7374/frontend/src/services/authService.js
```
...
```bash
# Add your files
git add src/main/java/edu/neu/csye7374/state/
git add src/main/java/edu/neu/csye7374/strategy/
git add src/main/java/edu/neu/csye7374/template/
git add src/main/java/edu/neu/csye7374/controller/AuthController.java
git add src/main/java/edu/neu/csye7374/controller/UserController.java
git add src/main/java/edu/neu/csye7374/service/AuthService.java
git add src/main/java/edu/neu/csye7374/service/UserService.java
git add src/main/java/edu/neu/csye7374/service/BillingService.java
git add src/main/java/edu/neu/csye7374/service/PaymentService.java
git add src/main/java/edu/neu/csye7374/entity/User.java
git add src/main/java/edu/neu/csye7374/repository/UserRepository.java
git add src/main/java/edu/neu/csye7374/dto/LoginRequest.java
git add src/main/java/edu/neu/csye7374/dto/LoginResponse.java
git add src/main/java/edu/neu/csye7374/dto/RegisterRequest.java
git add src/main/java/edu/neu/csye7374/config/JwtAuthenticationFilter.java
git add src/main/java/edu/neu/csye7374/config/SecurityConfig.java
git add src/main/java/edu/neu/csye7374/util/JwtUtil.java
git add src/main/java/edu/neu/csye7374/frontend/src/components/AppRoutes.jsx
git add src/main/java/edu/neu/csye7374/frontend/src/components/Layout.jsx
git add src/main/java/edu/neu/csye7374/frontend/src/context/AuthContext.js
git add src/main/java/edu/neu/csye7374/frontend/src/pages/Login.jsx
git add src/main/java/edu/neu/csye7374/frontend/src/pages/Register.jsx
git add src/main/java/edu/neu/csye7374/frontend/src/pages/Dashboard.jsx
git add src/main/java/edu/neu/csye7374/frontend/src/services/api.js
git add src/main/java/edu/neu/csye7374/frontend/src/services/authService.js

# Commit
git commit -m "feat: Implement State, Strategy, and Template Design Patterns

- Added State pattern for booking lifecycle management (State Pattern)
- Implemented Strategy pattern for payment, billing, and search (Strategy Pattern)
- Added Template pattern for booking processing workflow (Template Pattern)
- Enhanced authentication and authorization system with JWT
- Added user registration and login functionality
- Updated frontend for authentication flow
- Added print statements for all pattern activations"
```

## Testing Checklist:
- [ ] Test booking state transition: PENDING → ACTIVE (State)
- [ ] Test booking state transition: ACTIVE → COMPLETED (State)
- [ ] Test booking state transition: PENDING → CANCELLED (State)
- [ ] Test card payment strategy (Strategy)
- [ ] Test UPI payment strategy (Strategy)
- [ ] Test hourly billing strategy (Strategy)
- [ ] Test daily billing strategy (Strategy)
- [ ] Test weekend billing strategy (Strategy)
- [ ] Test search strategies (Strategy)
- [ ] Test standard booking processor (Template)
- [ ] Test premium booking processor (Template)
